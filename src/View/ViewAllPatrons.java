 ...
 * @author chath
 */
public class ViewAllPatrons extends javax.swing.JFrame {

    /**
     * Creates new form SearchPatrons
     */
    public ViewAllPatrons() {
        initComponents();
        new DataController().setIcon(this);
        new UpdateController().updatePatronTable(patronsTable);
    }
    ...
    private void initComponents() {
        ...
        searchByCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Patron Id", "NIC", "Telephone" }));
        ...
        topicLabel.setText("View Patrons");
        ...
        patronsTable.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
        patronsTable.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        patronsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Patron ID", "Name", "NIC", "Telephone"
            }
        ) {
        ...
        jScrollPane1.setViewportView(patronsTable);
        if (patronsTable.getColumnModel().getColumnCount() > 0) {
            patronsTable.getColumnModel().getColumn(0).setResizable(false);
            patronsTable.getColumnModel().getColumn(0).setPreferredWidth(1);
            patronsTable.getColumnModel().getColumn(1).setResizable(false);
            patronsTable.getColumnModel().getColumn(2).setResizable(false);
            patronsTable.getColumnModel().getColumn(3).setResizable(false);
            patronsTable.getColumnModel().getColumn(3).setPreferredWidth(1);
        }
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        // TODO add your handling code here:
        new SearchController().searchPatron(searchByCB, searchTF, patronsTable);
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        try {
            // TODO add your handling code here:
            new UpdateController().viewPatron(patronsTable, this);
        } catch (ParseException ex) {
            Logger.getLogger(ViewAllPatrons.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        try {
            // TODO add your handling code here:
            new UpdateController().updatePatronFromViewAll(patronsTable, this);
        } catch (ParseException ex) {
            Logger.getLogger(ViewAllPatrons.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        // TODO add your handling code here:
        new DeleteController().deletePatronFromTable(patronsTable);
        new UpdateController().updatePatronTable(patronsTable);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatrons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
